...
BLOG_AUTHOR = "Björn Ricks"  # (translatable)
BLOG_TITLE = "Björn Ricks"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://bjoernricks.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "bjoern.ricks@gmail.com"
...
TWITTER_CARD = {
    ...
    # twitter nick for the website
    # 'site': '@website',
    "card": "summary",
    "creator": "@bjoernricks",  # Username for the content creator / author.
}
